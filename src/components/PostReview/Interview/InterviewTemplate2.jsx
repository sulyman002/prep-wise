  ...
  return (
    <div className="flex flex-col p-6 gap-6 border-[2px] rounded-[16px] bg-gradient-to-b from-[#1A1C20] to-[#08090D] border-gray-300/40 ">
      <div className="h-[80px] w-[80px] md:h-[90px] md:w-[90px] rounded-full py-2 ">
        <img src={props.mainIcon} alt="" className="h-[80x] w-[80px] md:h-[90px] md:w-[90px] rounded-full "/>
      </div>
      <div>
        ...
        <p className="text-[#D6E0FF] py-4 text-[12px] mb-8 md:text-[16px] font-400 leading-[24px] ">{props.description}</p>
