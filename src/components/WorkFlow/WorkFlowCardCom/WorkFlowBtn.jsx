    ...
    <div>
      <div className="pt-4">
        <div className="md:flex gap-4 items-center justify-center ">
          <div className="cursor-pointer px-16 py-4 rounded-full flex items-center justify-center gap-2 bg-[#24273A] ">
          ...
          <div className="cursor-pointer px-8 py-4 rounded-full flex items-center justify-center gap-2 bg-[#F75353] ">
